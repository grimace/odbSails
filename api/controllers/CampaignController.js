...
module.exports = {
    ...
    remove: function (req,res) {
        ...
        Campaign.findOne().where({'id' : cid }).exec(function(err, campaign) {
            ...
            if (!campaign) { return res.json(new MessageResponse( false, 'Campaign not found')); }

//            if (typeof campaign == undefined) { 
//                return res.json(new MessageResponse( false, 'Campaign not found')); 
//            }
//            if (!campaign) { if (err) return res.json(new MessageResponse( false, 'Campaign not found')); }

            if (campaign.action && campaign.action.type && campaign.action.type === 'activated') {
