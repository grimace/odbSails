...
module.exports = flow = function(temporaryFolder) {
    ...
    $.gcf = function(cn, id) {
        identifier = cleanIdentifier(id);
        // What would the file name be?
        return '/flow-' + identifier + '.' + cn;
//        return getChunkFilename(cn, id);
    }
    ...
    $.write = function(identifier, writableStream, options) {
        ...
        console.log("flow.write for : "+identifier);
        options = options || {};
        ...
        var pipeChunk = function(number) {
            ...
            console.log('assembling identifier : ', identifier, ' , chunkFilename : ', chunkFilename);
            fs.exists(chunkFilename, function(exists) {
                ...
                if (exists) {
                    ...
                    sourceStream.on('end', function() {
                        ...
                        console.log('calling next pipeChunk - number : '+number+1);
                        pipeChunk(number + 1);
                    });
                    ...
                    console.log('chunk does not exist for : '+number);
