$( document ).ready(function() {
    ...
    d3.json("/purchase/api/report/poretailer", function(error, data) {
        if (error) return console.warn(error);

        var margin = {top: 0, right: 0, bottom: 0, left: 0},
            w = parseInt(d3.select('#poretailer').style('width'), 10),
